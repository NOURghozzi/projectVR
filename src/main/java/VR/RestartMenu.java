...
public class RestartMenu {
    ...
    private JPanel createPanel() {
        // Charger l'image
        ImageIcon backgroundIcon = new ImageIcon(getClass().getResource("/images/img.png"));
        Image backgroundImage = backgroundIcon.getImage();

        // Créer un JPanel personnalisé avec image en fond
        ...
        panel.setOpaque(false); // Laisse l'image visible
        ...
        // Tu peux continuer ici avec les boutons ou autres éléments...
